...
const I18N = {
  ko: {
    ...
    // 호수 입력
    'unit.placeholder': '동호수 입력 (예: 101동 201호)',
    'unit.add': '➕ 추가',
    'unit.bulk': '📋 일괄',
    'unit.delete': '삭제',
    'unit.search': '🔍 호수 검색',
    ...
    /* ★ 2026-08-16: 업종이 여러 개가 되면서 '에어컨' 고정값을 뺐다.
       업종이 설정돼 있으면 report.js 가 업종 이름으로 대체하고, 없을 때만 이 값이 쓰인다. */
    'report.cover.eyebrow': 'FIELD REPORT',
    'report.cover.title.before': '작업',
    'report.cover.title.after': '보고서',
    'report.cover.subtitle': '현장 작업 기록',
  ...
  en: {
    ...
    'report.cover.no': 'No.{n}',
    'report.cover.eyebrow': 'FIELD REPORT',
    'report.cover.title.before': 'Work',
    'report.cover.title.after': 'Report',
    'report.cover.subtitle': 'On-site work report',
    'report.cover.about': 'ABOUT US',
...
// 언어 기능 제거: 영어로 갇힌 사용자 한국어 복귀
try{ if(localStorage.getItem('ac_lang_v1')==='en') localStorage.setItem('ac_lang_v1','ko'); }catch(e){}
