...
(function () {
  ...
  var PRIVACY =
    ...
    '</div>' +
    '<h3>1. 수집하는 정보</h3>' +
    '· 계정: 이메일, 닉네임(로그인 시)<br>· 작업 데이터: 현장명·주소·전화번호·가격·작업 사진 등 이용자가 입력·촬영한 정보<br>· 문서 작성 시: 고객 사업자등록증 이미지에서 추출한 상호·등록번호·대표자·주소 등(이용자가 촬영·입력)<br>· 기기/이용 정보: 앱 동작에 필요한 최소한의 저장소 데이터' +
    '<h3>2. 저장 위치</h3>' +
    ...
    '<h3>9. 문의</h3>' +
    '개인정보 관련 문의: ' + contact() + '<br><br><span style="color:var(--mu);font-size:11px;">시행일: 2026-08-23</span>';
