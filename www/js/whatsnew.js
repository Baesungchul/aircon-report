...
(function () {
  ...
  var NOTES = {
    ...
    '3.2.38': {
      lead: '동선 지도의 선을 구간마다 다른 색으로 그립니다.',
      blocks: [
        {
          ic: '🗺️',
          title: '구간마다 카드와 같은 색으로 그려집니다',
          body: '선이 한 가지 색으로만 나오던 문제를 고쳤습니다. 이제 구간마다 아래 카드와 <b>같은 색</b>으로 그려지고, ' +
                '같은 길을 되짚는 구간은 그 위에 점선으로 얹힙니다.',
          subs: [
            '구간을 나눌 정보가 오지 않아도 앱이 직접 나눕니다'
          ]
        },
        {
          ic: '🧾',
          title: '견적서 도장이 글자를 가리지 않습니다',
          body: '도장 자리를 <b>대표 이름 오른쪽</b>으로 옮겼습니다. 상호와 등록번호를 덮던 문제가 없어집니다.'
        }
      ]
    },
    '3.2.37': {
      lead: '불러온 사진이 한 장씩 안 보이던 문제를 고쳤습니다.',
      blocks: [
        {
          ic: '📷',
          title: '불러온 사진이 빠짐없이 보입니다',
          body: '작업을 불러올 때 사진을 한꺼번에 읽다가 그중 한 장이 떨어져 나가는 일이 있었습니다. ' +
                '한 번에 읽는 장수를 줄이고, 읽지 못한 사진은 <b>스스로 다시 읽도록</b> 바꿨습니다.',
          subs: [
            '그래도 안 읽힌 칸은 표시가 남습니다. 그 칸을 누르면 다시 읽습니다',
            '폴더 목록을 못 읽었을 때 사진이 없는 것으로 보고 저장하던 경로도 막았습니다'
          ]
        },
        {
          ic: '🧾',
          title: '엑셀 견적서·거래명세서에 횟수가 적용됩니다',
          body: '문서 1건을 만들 때 AI 글작성 횟수를 1회 사용합니다. ' +
                '남은 횟수는 만들기 창 아래에 표시됩니다.',
          subs: [
            '같은 문서를 내려받고 공유해도 1회만 사용합니다',
            '내용을 고쳐 다시 만들면 새 문서로 보고 1회를 더 사용합니다'
          ]
        }
      ]
    },
    '3.2.36': {
      lead: '지도 선과 달력 접기를 다듬고, 글쓰기 지침이 항상 먼저 반영되게 했습니다.',
      blocks: [
        {
          ic: '📝',
          title: '직접 적은 지침이 가장 먼저 반영됩니다',
          body: '지침 편집에 적어 둔 내용이 앱에 들어 있는 기본 규칙보다 <b>우선</b>하도록 바꿨습니다. ' +
                '「상가 업체명은 쓰지 말 것」처럼 적어 두면 그대로 지켜집니다.',
          subs: [
            '블로그·SNS 글, 견적서, 일정 분석 세 곳 모두에 적용됩니다',
            '상가 상호·점포명은 이제 기본적으로 글에 쓰지 않습니다. 필요하면 지침에 적어서 켜면 됩니다',
            '사진에 간판이 찍혀 있어도 그 이름을 글로 옮기지 않습니다',
            '아파트 단지명은 지역 검색어라 그대로 씁니다'
          ]
        },
        {
          ic: '🗺️',
          title: '같은 길을 되짚어도 지도가 깔끔합니다',
          body: '겹치는 구간을 두 줄로 벌려 그리던 것을 되돌렸습니다. 선은 실제 길 위에 하나 그대로 두고, ' +
                '되짚는 구간만 그 위에 점선으로 얹어 <b>한 선이 두 색</b>으로 보입니다.'
        },
        {
          ic: '📅',
          title: '펼친 달력을 접을 때 부드럽게 움직입니다',
          body: '접는 동안 달력이 늘어났다 줄어들던 중간 모습을 없앴습니다. ' +
                '달력은 제 크기 그대로 있고 아래 내용만 미끄러져 올라옵니다.'
        },
        {
          ic: '🔔',
          title: '불필요한 경고를 없앴습니다',
          body: '저장 폴더에 작업 파일이 없는 평범한 폴더까지 「못 읽은 폴더」로 세는 바람에 ' +
                '화면 위에 경고 띠가 계속 뜨던 문제를 고쳤습니다.',
          subs: [
            '일정이 정말로 며칠째 안 올라가는 경우에는 그대로 알려 드립니다'
          ]
        },
        {
          ic: '📄',
          title: '보고서 표지에 한 줄이 들어갑니다',
          body: '보고서 표지 맨 아래에 작은 글씨로 「현장매니저 앱으로 만든 보고서」가 들어갑니다. ' +
                '설정 ▸ 📄 보고서 설정 ▸ 표지 문구 에서 끌 수 있습니다.'
        }
      ]
    },
