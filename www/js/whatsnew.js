  ...
  var NOTES = {
    ...
    /* ★ 2026-09-17 지도 기능.
         ⚠️ 이 키는 **실제로 스토어에 올리는 버전과 같아야** 뜬다(tick 이 NOTES[APP_VERSION]
            ...
            안 옮기면 안내가 조용히 안 뜬다. bump-version.js 가 그때 경고해 준다. */
    '3.2.30': {
      lead: '그날 갈 곳을 지도로 볼 수 있습니다.',
      blocks: [
        {
          ic: '🗺',
          title: '날짜를 누르면 나오는 목록에 [지도]가 생겼습니다',
          body: '그날 갈 곳들이 시간 순서대로 번호가 붙어 지도에 찍힙니다. ' +
                '아래 카드를 옆으로 넘기면서 가고 싶은 곳의 길안내를 바로 누를 수 있습니다.',
          subs: [
            '주소가 적힌 작업이 <b>두 곳 이상</b>인 날에만 [지도]가 보입니다',
