    ...
    '3.2.31': {
      ...
      blocks: [
        ...
        },
        {
          ...
          body: '지도 위쪽 [집]·[회사] 칩을 누르면 길안내가 곧바로 열립니다. ' +
                '[복귀]를 켜면 마지막 작업에서 집이나 회사로 돌아가는 길까지 동선에 들어갑니다.',
          subs: [
            '칩을 <b>길게 누르면</b> 주소를 고칠 수 있습니다 (설정 → 내 장소에서도 됩니다)',
            '[복귀]는 눌러서 켜고, 한 번 더 누르면 집 → 회사 → 끄기로 바뀝니다',
