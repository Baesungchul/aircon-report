...
(function () {
  ...
  var NOTES = {
    ...
    '3.2.33': {
      lead: '지운 사진을 언제든 되살릴 수 있습니다.',
      blocks: [
        {
          ic: '🗑',
          title: '호수마다 사진 휴지통이 생겼습니다',
          body: '사진을 지워도 바로 없어지지 않고 그 호수의 <b>휴지통</b>으로 들어갑니다. ' +
                '작업을 닫았다 다시 열어도 그대로 남아 있어서, 며칠 뒤에도 되살릴 수 있습니다.',
          subs: [
            '호수 카드를 내리면 <b>🗑 삭제된 사진</b> 줄이 있습니다 — 눌러서 펼치고 복원하세요',
            '한 장씩도, 한꺼번에도 되살릴 수 있습니다',
            '<b>휴지통을 비울 때만</b> 사진이 진짜로 지워집니다',
            '예전에는 작업을 닫으면 지운 사진을 영영 못 찾았습니다 — 그 문제를 고쳤습니다'
          ]
        },
        {
          ic: '📖',
          ...
          body: '설정 맨 아래 <b>앱 정보</b>에 <b>사용설명서</b>와 <b>브라우저에서 보기</b>가 있습니다. ' +
                'PC 로 크게 보거나 팀원에게 주소를 보낼 때 쓰세요.'
        }
      ]
    },

    '3.2.32': {
      lead: '설명서가 앱 안으로 들어왔습니다.',
      blocks: [
        {
          ic: '📖',
          title: '설정에 [사용설명서]가 생겼습니다',
          body: '처음 쓰는 순서대로 7부 34칸으로 적었습니다. ' +
                '화면 사진을 곁들여 어디를 눌러야 하는지 그대로 보여 드립니다. ' +
                '큰제목을 누르면 그 부분만 펼쳐집니다.',
          subs: [
            'AI 글작성은 <b>휴대폰으로 올리기</b>와 <b>PC로 올리기</b>를 따로 적었습니다',
            '견적서·거래명세서, 동선 보기, 팀 공유도 화면 그대로 따라갈 수 있습니다',
            '막히는 곳은 마지막 <b>이럴 때는 이렇게</b>에서 찾아보세요'
          ]
        },
        {
          ic: '🔔',
          title: '작업 시간을 바꾸면 알림도 같이 바뀝니다',
          body: '시간을 고쳤는데 <b>예전 시간에 알림이 오던 문제</b>를 고쳤습니다. ' +
                '이제 고쳐 저장하는 즉시 알림을 다시 겁니다.',
          subs: [
            '일정을 새로 만들거나 네이버에서 가져올 때도 바로 알림이 걸립니다'
          ]
        }
      ]
    },
