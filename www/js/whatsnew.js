...
(function () {
  ...
  var NOTES = {
    ...
    '3.2.15': {
      ...
      blocks: [
        ...
        },
        {
          ...
          body: '네이버로 사진을 공유하면 글쓰기 화면 맨 위에 한꺼번에 들어가서 하나씩 ' +
    ...
    '3.2.35': {
      lead: '견적서와 거래명세서에 직인을 찍을 수 있습니다.',
      blocks: [
        {
          ic: '🔖',
          title: '도장 이미지를 한 번 올려 두면 자동으로 찍힙니다',
          body: '설정 ▸ 🏢 업체정보에 <b>직인(도장)</b> 칸이 생겼습니다. ' +
                '도장 이미지를 한 번 올려 두면 이후 만드는 견적서·거래명세서에 자동으로 들어갑니다.',
          subs: [
            '견적서는 공급자 <b>상호·대표</b> 줄에 찍힙니다',
            '거래명세서는 공급자 <b>성명</b> 칸 옆에 찍히며, 한 장에 두 벌이라 양쪽 모두 찍힙니다',
            '배경이 투명한 PNG 가 가장 깨끗합니다. 흰 배경이면 앱이 흰색을 지워 넣습니다',
            '직인은 업체정보와 함께 저장되고 백업에도 포함됩니다'
          ]
        }
      ]
    },
    ...
    '3.2.34': {
      lead: '앱 문구를 한 가지 말투로 정리했습니다.',
      blocks: [
        {
          ic: '✏️',
          title: '안내 문구를 모두 「합니다」체로 맞췄습니다',
          body: '화면마다 「~해요」와 「~합니다」가 섞여 있던 것을 하나로 통일했습니다. ' +
                '기능이 바뀐 것은 없고 문구만 손봤습니다.',
          subs: [
            '설정 ▸ 공유 설정의 안내가 실제 방식(팀 초대 코드)에 맞게 바뀌었습니다',
            '사용설명서 문구도 같은 기준으로 다듬었습니다'
          ]
        }
      ]
    },
    ...
    '3.2.33': {
      lead: '삭제한 사진을 언제든 복구할 수 있습니다.',
      blocks: [
        {
          ic: '🗑',
          title: '호수마다 사진 휴지통이 생겼습니다',
          body: '사진을 삭제해도 바로 지워지지 않고 해당 호수의 <b>휴지통</b>으로 이동합니다. ' +
                '작업을 닫았다 다시 열어도 그대로 남아 있어 나중에도 복구할 수 있습니다.',
          subs: [
            '호수 카드 아래쪽 <b>🗑 삭제된 사진</b>을 누르면 목록이 펼쳐집니다',
            '한 장씩 또는 한꺼번에 복원할 수 있습니다',
            '<b>휴지통을 비울 때만</b> 사진이 실제로 삭제됩니다',
            '이전에는 작업을 닫으면 삭제한 사진을 복구할 수 없었습니다'
          ]
        },
        {
          ic: '📖',
          title: '설명서를 브라우저에서도 볼 수 있습니다',
          body: '설정 맨 아래 <b>앱 정보</b>에 <b>사용설명서</b>와 <b>브라우저에서 보기</b>가 있습니다. ' +
                'PC 화면으로 크게 보거나 팀원에게 주소를 보낼 때 사용하세요.'
        }
      ]
    },

    '3.2.32': {
      lead: '앱 안에서 사용설명서를 볼 수 있습니다.',
      blocks: [
        {
          ic: '📖',
          title: '설정에 [사용설명서]가 생겼습니다',
          body: '처음 사용하는 순서대로 7부 34개 항목으로 정리했습니다. ' +
                '화면 사진과 함께 어디를 눌러야 하는지 그대로 보여 드립니다. ' +
                '큰제목을 누르면 그 부분만 펼쳐집니다.',
          subs: [
            'AI 글작성은 <b>휴대폰으로 올리기</b>와 <b>PC로 올리기</b>를 나눠서 정리했습니다',
            '견적서·거래명세서, 동선 보기, 팀 공유도 화면 그대로 따라갈 수 있습니다',
            '막히는 부분은 마지막 <b>이럴 때는 이렇게</b>에서 찾아보세요'
          ]
        },
        {
          ic: '🔔',
          title: '작업 시간을 바꾸면 알림 시간도 함께 변경됩니다',
          body: '작업 시간을 바꿔도 <b>이전 시간에 알림이 오던 문제</b>를 수정했습니다. ' +
                '이제 시간을 변경해 저장하면 알림도 즉시 다시 설정됩니다.',
          subs: [
            '일정을 새로 만들거나 네이버에서 가져올 때도 알림이 바로 설정됩니다'
          ]
        }
      ]
    },
      ...
      blocks: [
              ...
              대신 **버튼이 생겼다는 것**과 **언제 누르면 되는지**만 적는다. */
        {
          ...
          body: '내 일정을 서버와 처음부터 다시 맞춥니다. ' +
                '평소에는 앱이 자동으로 맞추지만, 어긋난 것이 보이면 직접 누를 수 있습니다.',
          subs: [
